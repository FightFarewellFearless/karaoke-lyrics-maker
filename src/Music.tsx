...
export default function Music(props: z.infer<typeof DefaultSchema>) {
  ...
  const currentLyricObj =
    currentLineIndex !== -1 ? props.syncronizeLyrics[currentLineIndex] : null;
  ...
  const previousLyrics =
    props.syncronizeLyrics[currentLineIndex - 1]?.text || "";
  ...
  const showCountdown =
    isInstrumental && timeUntilNextLine <= 3 && timeUntilNextLine > 0;
  ...
  return (
    <>
      ...
      >
        ...
        {showCountdown && (
          <>
            <CountdownIndicator timeUntilNext={timeUntilNextLine} />
            <div
              style={{
                position: "absolute",
                top: "65%",
