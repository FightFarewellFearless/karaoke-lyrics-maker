...
export async function downloadMusicFile(title) {
  ...
  execSync(`${process.cwd()}/venv/bin/stable-ts ./audio_output/vocals_output.mp3 --align ./public/plainLyrics.txt --language ${translate.src} --denoiser demucs --vad true --segment_level false -o ./public/wordByWordLyrics.vtt -to "original_split=1" --model medium`);
}
